...
export function PageState({ loading, error, connected, empty }) {
  if (!connected) return <ReminderBanner title="MetaMask connection required">Connect your registered Sepolia wallet to load agreements and continue.</ReminderBanner>
